...
class Plugin_Dependencies {
	 ...
	 */
	public function get_requirement_notices( $plugin_name = false ) {
		if ( ! $plugin_name )
	 ...
	 */
	private function parse_dependency( $dependency ) {
		global $wp_version;
	 ...
	 */
	private function check_incompatibility( $v, $current_version ) {
		if ( !empty( $v['versions'] ) ) {
